...
const Button: React.FC<ButtonProps> = ({
  ...
  let base = "inline-flex items-center justify-center font-semibold rounded-md transition-all";
  ...
  else if (variant === "outline") base += " border border-border bg-transparent text-foreground";
