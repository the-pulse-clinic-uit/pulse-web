...
export default function PrescriptionHeader() {
  ...
  return (
    <div className="flex items-center justify-between mb-6">
      <div>
        <p className="text-gray-500 text-sm">Hi, Dr. John Doe!</p>
        <h1 className="text-2xl font-semibold text-gray-900">Manage Prescription</h1>
      </div>
      ...
      <div className="flex items-center gap-4">
        <div className="relative" ref={calendarRef}>
          ...
          >
            ...
            <span className="text-sm text-gray-600">{formatDisplayDate()}</span>
