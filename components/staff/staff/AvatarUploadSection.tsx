...
const AvatarUploadSection = ({
    ...
    const handleChangeAvatar = async (
        ...
        try {
            ...
            if (userStr) {
                const staffData = JSON.parse(userStr);
                if (staffData.userDto) {
                    staffData.userDto.avatarUrl = updatedUser.avatarUrl;
                    Cookies.set("user", JSON.stringify(staffData), {
                        expires: 7,
                    });
                }
            }
