...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer id="contact" className="bg-foreground text-background scroll-mt-24">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-background/70 leading-relaxed">
              Providing exceptional healthcare services with compassion, dignity, and unwavering
              commitment to your well-being since {yearFounded}.
            </p>
