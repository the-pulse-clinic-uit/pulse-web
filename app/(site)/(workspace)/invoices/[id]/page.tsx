...
export default function InvoiceDetailPage({ params }: Props) {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `/api/invoices/${invoice.id}/create-payment`,
                {
                    method: "GET",
                    headers: {
                        Authorization: `Bearer ${token}`,
    ...
    const handleDownload = () => {
        ...
        yPosition += 5;
        doc.text(
            `Doctor: ${invoice.encounterDto.doctorDto.staffDto.userDto.fullName}`,
            20,
            yPosition
        );
        yPosition += 5;
        ...
        if (invoice.encounterDto.prescriptionDto?.prescriptionDetails) {
            ...
            yPosition += 10;
            invoice.encounterDto.prescriptionDto.prescriptionDetails.forEach(
                (detail, index) => {
                    if (yPosition > 250) {
                        doc.addPage();
                        yPosition = 20;
                    ...
                    doc.setFont("helvetica", "normal");
                    doc.text(
                        `Quantity: ${detail.quantity} | Unit Price: ${formatVND(
                            detail.drugDto.unitPrice
                        )}`,
                        25,
                        yPosition
                    );
                    ...
                    doc.text(
                        `Total: ${formatVND(
                            detail.quantity * detail.drugDto.unitPrice
                        )}`,
                        25,
                        yPosition
                    );
        ...
        doc.setFont("helvetica", "bold");
        doc.text(
            `Total Amount: ${formatVND(invoice.totalAmount)}`,
            20,
            yPosition
        );
        ...
        if (invoice.amountPaid > 0) {
            yPosition += 7;
            doc.text(
                `Amount Paid: ${formatVND(invoice.amountPaid)}`,
                20,
                yPosition
            );
            yPosition += 7;
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                ...
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4 text-purple-100">
                                    ...
                                    <span className="flex items-center gap-1">
                                        ...
                                        {
                                            invoice.encounterDto.doctorDto
                                                .staffDto.userDto.fullName
                                        }
                                    </span>
                                </div>
                            </div>
                    ...
                    <div className="p-6">
                            ...
                            <div>
                                ...
                                <div className="text-gray-600 space-y-1">
                                    <p className="font-medium text-gray-900">
                                        {
                                            invoice.encounterDto.patientDto
                                                .userDto.fullName
                                        }
                                    </p>
                                    <p>
                                ...
                                <div className="text-gray-600 space-y-1">
                                    ...
                                    {invoice.encounterDto.doctorDto
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">
                                                {
                                                    invoice.encounterDto
                                                        .doctorDto.departmentDto
                                                        .name
                                                }
                                            </span>
                                        </div>
                        ...
                        {invoice.encounterDto.prescriptionDto
                            ?.prescriptionDetails && (
                            <div className="mb-6">
