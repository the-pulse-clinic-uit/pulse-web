...
const CoreValuesSection: React.FC<CoreValuesSectionProps> = ({
  ...
  return (
    <section id={id} className="py-20 lg:py-32 bg-section-alt">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-muted-foreground text-lg">
            These principles guide everything we do at The Pulse Clinic, ensuring
            we deliver healthcare that truly makes a difference.
          </p>
        </div>
